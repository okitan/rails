...
INFO. This guide documents autoloading in `classic` mode, which is the traditional one. If you'd like to read about the new `zeiwerk` mode instead, please check [Autoloading and Reloading Constants (Zeitwerk Edition)][autoloading_and_reloading_constants_zeitwerk.html].
